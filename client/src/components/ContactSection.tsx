                  ...
                  <CardContent>
                    ...
                    <div className="mt-10 space-y-6">
                      ...
                      <div className="grid md:grid-cols-2 gap-6">
                        {/* Nairobi Map */}
                        <div>
                          <h4 className="font-medium mb-2">Jolu Regional Office & Showroom – Nakuru, Kenya</h4>
                          <iframe
                        ...
                        {/* Nakuru Map */}
                        <div>
                          <h4 className="font-medium mb-2">Jolu Security Office – KFA Building, Nakuru</h4>
                          <iframe
                          ...
                          ></iframe>
                                                ...
                                                {/* Rongo Map */}
                        <div>
                          <h4 className="font-medium mb-2">Jolu Office - Quickfill Service Station – Rongo, Migori</h4>
                          <iframe
