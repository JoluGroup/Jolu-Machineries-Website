...
const ContactSection = () => {
  ...
  const contactInfo = [
    ...
    { icon: MapPin, title: "Locations", details: ["Nairobi, Kenya", "Nakuru, Kenya", "Rongo, Migori", "Awasi, Kisumu"], action: "Get Directions" },
                  ...
                  <CardContent>
                    ...
                    <div className="mt-10 space-y-6">
                      <h3 className="text-xl font-semibold">Find Us</h3>
                       ...
                       {/* Kisumu Map */}
                        <div>
                          <h4 className="font-medium mb-2">2. Jolu Kisumu Office – Awasi, Kisumu</h4>
                        </div>
                      <div className="grid md:grid-cols-2 gap-6">
                        {/* Nakuru Map */}
                        <div>
                          <h4 className="font-medium mb-2">3. Jolu Regional Office & Showroom – Nakuru, Kenya</h4>
                          <iframe
                        ...
                        {/* Nakuru KFA Map */}
                        <div>
                          <h4 className="font-medium mb-2">4. Jolu Security Office – KFA Building, Nakuru</h4>
                          <iframe
                          ...
                          ></iframe>
                                                ...
                                                {/* Rongo Map */}
                        <div>
                          <h4 className="font-medium mb-2">5. Jolu Office - Quickfill Service Station – Rongo, Migori</h4>
                          <iframe
